...
6. ~~**Parte IV (13–14):** Extensiones (primas comerciales, valor de rescate, normativa, desgravamen, tablas selectas, múltiples vidas, múltiple decremento, modelos estocásticos) y Resumen y perspectivas (resumen por partes, aplicaciones, perspectivas MA II, Actuarial Cortex / EECA).~~ Hecho; vaciado extenso.
7. Revisar **PL II-2024** por semana para extraer ejercicios o ejemplos concretos de los PDFs cuando se necesiten.

---

*Inventario generado para el proyecto Actuarial Cortex. Fuentes: GuiaAct1_27-01-2017.pdf y carpeta Matemáticas Actuariales I PL II-2024 (Documentos).*
