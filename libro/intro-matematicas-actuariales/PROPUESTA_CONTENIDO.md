...
| 4 | Probabilidades y expectativas: $_n p_x$, $_n q_x$, $e_x$, vida truncada/complete; interpolación | 3–4 |
...
*Documento generado para el proyecto del libro *Introducción a las Matemáticas Actuariales*, Actuarial Cortex / EECA-UCV. Material base: [Matemáticas Actuariales I PL II-2024, Google Drive](https://drive.google.com/drive/folders/1eD-0wb4dxDdgBI6reOzznviNyEVxHLym?usp=sharing).*
